...
BLDCDriver3PWM driverX = BLDCDriver3PWM(5, 7, 15, 18);
BLDCDriver3PWM driverY = BLDCDriver3PWM(4, 6, 16, 17);
...
void initMotorY() {
    loadYMotorParams();
    motorY.setPostions(11.12, 10.42, 9.87, 0.075);
    sensorY.init();
    motorY.linkSensor(&sensorY);
    driverY.voltage_power_supply = 12;
    driverY.pwm_frequency = 20000;
    driverY.init();
...
void initMotorX() {
    loadXMotorParams();
    motorX.setPostions(10.10, 9.57, 9.16, 0.075);
    sensorX.init();
    motorX.linkSensor(&sensorX);
    driverX.voltage_power_supply = 12;
    driverX.pwm_frequency = 20000;
    driverX.init();
