...
class HallSensor: public Sensor{
 public:
    ...
    */
    HallSensor(gpio_num_t encA, gpio_num_t encB, gpio_num_t encC, int pp);
    ...
    /** All channel update function */
    void handleAll();
    
    
    // pins A and B
    gpio_num_t pinA; //!< HallSensor hardware pin A
    gpio_num_t pinB; //!< HallSensor hardware pin B
    gpio_num_t pinC; //!< HallSensor hardware pin C
